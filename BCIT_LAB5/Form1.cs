        ...
        public static int Distance(string str1, string str2)
        {
            ...
            for (int i = 1; i <= str1Len; ++i)
            {
                for (int j = 1; j <= str2Len; ++j)
                {
                    ...
                    int symbEqual = (string1.Substring(i - 1, 1)
                        == string2.Substring(j - 1, 1) ? 0 : 1);
                    ...
                    if ((i > 1) && (j > 1) && (string1.Substring(i - 1, 1)
                        == string2.Substring(j - 2, 1)) &&
                        (string1.Substring(i - 2, 1) == string2.Substring(j - 1, 1)))
                    {
